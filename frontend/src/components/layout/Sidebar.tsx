...
const navigation = [
  { label: "Overview", path: "/overview", icon: Radar },
  ...
  return (
    <aside className="sidebar" aria-label="Application navigation">
      <div className="brand">
        ...
        <div>
          <div className="brand-name">Job Intelligence</div>
          <div className="brand-version">v2.1 workspace</div>
        </div>
      </div>
      ...
      <div className="sidebar-footer">
        <div className="system-pill" role="status" aria-label="System online">
