        ...
        if job_ids:
            existing_rows = (
                session.scalars(
                    ...
                    .where(
                        JobGapAnalysisRecord.job_id.in_(
                            job_ids
                        )
                    )
                ).all()
        ...
        for index, (
            ...
            try:
                ...
                if existing is None:
                    ...
                    existing.matched_required_skills = (
                        analysis
                        .matched_required_skills
                    )

                    existing.missing_required_skills = (
                        analysis
                        .missing_required_skills
                    )
                    ...
                    existing.matched_platforms = (
                        analysis
                        .matched_platforms
                    )

                    existing.missing_platforms = (
                        analysis
                        .missing_platforms
                    )
                    ...
                    existing.experience_fit = (
                        analysis.experience_fit
                    )

                    existing.experience_gap_years = (
                        analysis
                        .experience_gap_years
                    )
