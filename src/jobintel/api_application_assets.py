...
def serialize_asset(
    ...
    return {
        ...
        "skills_to_emphasize": (
            record.skills_to_emphasize
        ),
        "missing_skills_warning": (
            record.missing_skills_warning
        ),
        "resume_bullets_to_emphasize": (
            record.resume_bullets_to_emphasize
        ),
        "interview_talking_points": (
            record.interview_talking_points
        ),
        "generated_payload": (
            record.generated_payload
        ),
        "created_at": (
...
def regenerate_assets(
    ...
    return {
        "message": (
            "Application assets regenerated"
        ),
        "application_assets": (
            serialize_asset(
                record
